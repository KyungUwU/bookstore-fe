	...
	return (
		<div className='container my-5 bg-super-light p-4 rounded'>
			...
			<p>
				...
				khuyết, hư hỏng hoặc không như mô tả, G1Book cam kết bảo vệ khách
			...
			<p>
				...
				<a href='#!chinh-sach-doi-tra-hang'>
					<strong>G1Book.com/chinh-sach-doi-tra-hang</strong>
				</a>{" "}
			...
			<ul>
				<li>
					<p>Quý khách vui lòng thông báo về cho <strong>G1Book</strong> ngay khi:</p>
					<p>
						{" "}
				...
				<li>
					<p>
						Sau khi <strong>G1Book</strong> xác nhận mail tiếp nhận yêu cầu kiểm tra xử
						lý, <strong>G1Book</strong> sẽ liên hệ đến quý khách để xác nhận thông tin
						hoặc nhờ bổ sung thông tin (nếu có). Trường hợp không liên hệ
						được <strong>G1Book</strong> rất tiếc xin được phép từ chối xử lý yêu cầu.
						Thời gian <strong>G1Book</strong> liên hệ trong giờ hành chính tối đa 3 lần
			...
			<p>
				...
				<strong>G1Book</strong> trong vòng 30 ngày kể từ khi nhận hàng với
			...
			<br />
			<p>
				<strong>G1Book</strong> hỗ trợ đổi/ trả sản phẩm cho quý khách nếu:
			</p>
			<ul>
				<li>
			...
			<ul>
				<li>
					<p>
						...
						<strong>cskh@g1book.com.vn</strong> với tiêu đề{" "}
			...
			<ul>
				<li>
					Để đảm bảo quyền lợi khách hàng và để <strong>G1Book</strong> có
					...
					clip từ quý khách, <strong>G1Book</strong> xin phép từ chối hỗ
					trợ.
				</li>
			</ul>
			<table
			...
			>
				<tbody>
					...
					<tr>
						...
						<td>
							<p>G1Book có sản phẩm→ đổi mới cùng sản phẩm</p>
							<p>
								G1Book hết hàng→ Hoàn tiền hoặc quý khách có thể chọn
					...
					<tr>
						...
						<td>
							...
							<p>
								**Lưu ý: G1Book rất tiếc sẽ không hỗ trợ hoàn lại chi
